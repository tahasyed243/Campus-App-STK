...
const Footer = () => {
  return (
    <footer className="border-t w-screen bg-gray-300 border-t-gray-200 py-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">STK Job Portal</h2>
            <p className="text-md">© 2025
               <a
               className="text-[#F83002] m-1 font-bold hover:underline duration-700 cursor-pointer"> 
              STK Job Portal</a>. 
               All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com/syed.taha.39566" target="blank"
            className="hover:text-blue-700" aria-label="Facebook">
            ...
            <a href="https://x.com/tahasyed243" target="blank"
             className="hover:text-blue-500" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/syed-taha-86b05a295/" target="blank"
             className="hover:text-blue-700" aria-label="LinkedIn">
